...
/* ===================== hollywood_emu: timer + GIC IRQ delivery =====================
 * QEMU's gt_recalc_timer is #if 0'd in this build and there is no GIC device, so
 * we derive the ARM generic-timer output from the (working) counter and the
 * guest-programmed ctl/cval, assert the CPU IRQ line, and answer the GICv3 CPU
 * interface ICC_IAR1/EOIR1 with the timer's GIC INTID. The distributor enable is
 * gated by the guest's own timer enable (CNTx_CTL.ENABLE), which the kernel only
 * sets after registering the handler. Polled from the emulator's per-instruction
 * hook via uc_arm64_timer_poll(). Single-CPU. */
#define HW_VIRT_INTID 27   /* PPI 11: arch virtual timer  */
...
static void hw_icc_eoir1_write(CPUARMState *env, const ARMCPRegInfo *ri, uint64_t value)
{
...
void register_cp_regs_for_features(ARMCPU *cpu)
{
    ...
    /* hollywood_emu: minimal GICv3 CPU interface (ICC_* system registers) so the
     * Linux gic-v3 driver can enable the sysreg interface and initialize. There is
     * no GICv3 device here, so these read as sane constants and ignore writes;
     * interrupt delivery is not modeled. ICC_SRE_EL1.SRE reads 1 (loop exit). */
    if (arm_feature(env, ARM_FEATURE_AARCH64)) {
        static const ARMCPRegInfo gicv3_dummy_cpuif_reginfo[] = {
            { .name = "ICC_PMR_EL1",    .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 4,  .crm = 6,  .opc2 = 0, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0xf0 },
            { .name = "ICC_IAR0_EL1",   .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 8,  .opc2 = 0, .access = PL1_R,  .type = ARM_CP_CONST, .resetvalue = 1023 },
            { .name = "ICC_EOIR0_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 8,  .opc2 = 1, .access = PL1_W,  .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_HPPIR0_EL1", .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 8,  .opc2 = 2, .access = PL1_R,  .type = ARM_CP_CONST, .resetvalue = 1023 },
            { .name = "ICC_BPR0_EL1",   .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 8,  .opc2 = 3, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_AP0R0_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 8,  .opc2 = 4, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_AP0R1_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 8,  .opc2 = 5, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_AP0R2_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 8,  .opc2 = 6, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_AP0R3_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 8,  .opc2 = 7, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_AP1R0_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 9,  .opc2 = 0, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_AP1R1_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 9,  .opc2 = 1, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_AP1R2_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 9,  .opc2 = 2, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_AP1R3_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 9,  .opc2 = 3, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_DIR_EL1",    .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 11, .opc2 = 1, .access = PL1_W,  .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_RPR_EL1",    .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 11, .opc2 = 3, .access = PL1_R,  .type = ARM_CP_CONST, .resetvalue = 0xff },
            { .name = "ICC_SGI1R_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 11, .opc2 = 5, .access = PL1_W,  .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_ASGI1R_EL1", .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 11, .opc2 = 6, .access = PL1_W,  .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_SGI0R_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 11, .opc2 = 7, .access = PL1_W,  .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_IAR1_EL1",   .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 12, .opc2 = 0, .access = PL1_R,  .type = ARM_CP_IO | ARM_CP_NO_RAW, .readfn = hw_icc_iar1_read },
            { .name = "ICC_EOIR1_EL1",  .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 12, .opc2 = 1, .access = PL1_W,  .type = ARM_CP_IO | ARM_CP_NO_RAW, .writefn = hw_icc_eoir1_write },
            { .name = "ICC_HPPIR1_EL1", .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 12, .opc2 = 2, .access = PL1_R,  .type = ARM_CP_CONST, .resetvalue = 1023 },
            { .name = "ICC_BPR1_EL1",   .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 12, .opc2 = 3, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_CTLR_EL1",   .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 12, .opc2 = 4, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0x700 },
            { .name = "ICC_SRE_EL1",    .state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 12, .opc2 = 5, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0x7 },
            { .name = "ICC_IGRPEN0_EL1",.state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 12, .opc2 = 6, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            { .name = "ICC_IGRPEN1_EL1",.state = ARM_CP_STATE_AA64, .opc0 = 3, .opc1 = 0, .crn = 12, .crm = 12, .opc2 = 7, .access = PL1_RW, .type = ARM_CP_CONST, .resetvalue = 0 },
            REGINFO_SENTINEL
        };
         ...
         * SYSTEM_RESET, ...) are then handled internally instead of trapping to
         * a non-existent EL3 firmware. */
